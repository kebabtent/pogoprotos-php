 ...
 *
 * File descriptor :
 * POGOProtos/Networking/Responses/UpdateNotificationResponse.proto
 */
...
/**
 * Protobuf message : POGOProtos.Networking.Responses.UpdateNotificationResponse
 */
class UpdateNotificationResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'state' value
     *
     * @param \POGOProtos\Enums\NotificationState $value
     */
    public function setState(\POGOProtos\Enums\NotificationState $value = null)
    {
        $this->state = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.POGOProtos.Enums.NotificationState'
                ]),
            ],
        ]);
    }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 3) {
                ...
                $this->state = \POGOProtos\Enums\NotificationState::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Responses\UpdateNotificationResponse) {
