 ...
 *
 * File descriptor : POGOProtos/Networking/Requests/Messages/GymDeployMessage.proto
 */
...
/**
 * Protobuf message : POGOProtos.Networking.Requests.Messages.GymDeployMessage
 */
class GymDeployMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Requests\Messages\GymDeployMessage) {
