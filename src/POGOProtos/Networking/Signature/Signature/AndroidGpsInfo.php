...
/**
 * Protobuf message : POGOProtos.Networking.Signature.Signature.AndroidGpsInfo
 */
class AndroidGpsInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Signature\Signature\AndroidGpsInfo) {
