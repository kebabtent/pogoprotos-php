...
//   require('POGOProtos/Networking/Envelopes/RequestEnvelope.proto.php');
...
namespace POGOProtos\Networking\Envelopes {
  ...
  require('POGOProtos/Networking/Requests/Request.proto.php');
  require('POGOProtos/Networking/Envelopes/AuthTicket.proto.php');
  require('POGOProtos/Networking/Envelopes/Unknown6.proto.php');
