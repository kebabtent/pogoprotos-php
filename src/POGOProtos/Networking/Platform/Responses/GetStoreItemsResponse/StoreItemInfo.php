 ...
 */
class StoreItemInfo extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Platform\Responses\GetStoreItemsResponse\StoreItemInfo) {
