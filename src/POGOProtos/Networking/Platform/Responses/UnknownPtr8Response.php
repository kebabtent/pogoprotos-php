 ...
 *
 * File descriptor :
 * POGOProtos/Networking/Platform/Responses/UnknownPtr8Response.proto
 */
...
/**
 * Protobuf message : POGOProtos.Networking.Platform.Responses.UnknownPtr8Response
 */
class UnknownPtr8Response extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Platform\Responses\UnknownPtr8Response) {
