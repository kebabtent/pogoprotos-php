 ...
 *
 * File descriptor :
 * POGOProtos/Networking/Platform/Requests/BuyItemPokeCoinsRequest.proto
 */
...
/**
 * Protobuf message :
 * POGOProtos.Networking.Platform.Requests.BuyItemPokeCoinsRequest
 */
class BuyItemPokeCoinsRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \POGOProtos\Networking\Platform\Requests\BuyItemPokeCoinsRequest) {
