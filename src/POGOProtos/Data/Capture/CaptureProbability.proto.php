...
//   require('POGOProtos/Data/Capture/CaptureProbability.proto.php');
...
namespace POGOProtos\Data\Capture {
  ...
  final class CaptureProbability extends ProtobufMessage {
    ...
    private $_unknown;
    private $pokeballType = array(); // repeated .POGOProtos.Inventory.Item.ItemId pokeball_type = 1
    ...
    public function read($fp, &$limit = PHP_INT_MAX) {
      ...
      while(!feof($fp) && $limit > 0) {
        ...
        $field = $tag >> 3;
        switch($field) {
          case 1: // repeated .POGOProtos.Inventory.Item.ItemId pokeball_type = 1
            if($wire !== 2 && $wire !== 0) {
